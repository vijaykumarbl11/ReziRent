...
public class ShowHostelFragment extends Fragment {


    public ShowHostelFragment() {
        // Required empty public constructor
    }
    ArrayList<SingleIDClass> list123=new ArrayList<>();
    HostelOwnAdapter adapter123;
  FragmentShowHostelBinding binding;
  ...
  ProgressDialog dialog;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter123=new HostelOwnAdapter(getContext(),list123);
        binding.showrentrec.setAdapter(adapter123);
        ...
        binding.adddataimage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), AddHostelActivity.class);
