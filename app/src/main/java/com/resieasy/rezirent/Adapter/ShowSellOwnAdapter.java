...
public class ShowSellOwnAdapter extends RecyclerView.Adapter<ShowSellOwnAdapter.ViewHolder> {
    ...
    public ShowSellOwnAdapter(Context context, ArrayList<SingleIDClass> list) {
        this.context = context;
        this.list = list;
    }
    @NonNull
    @Override
    public ShowSellOwnAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.showsellownersample, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ShowSellOwnAdapter.ViewHolder holder, int position) {
       ...
       String  id = data.getId();
        ...
        InterstitialAd.load(context, String.valueOf(R.string.Ownselleditinterstitial_id), adRequestedit,
        ...
        InterstitialAd.load(context, String.valueOf(R.string.Ownsellshowinterstitial_id), adRequestshow,
                new InterstitialAdLoadCallback() {
                    @Override
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        // The mInterstitialAd reference will be null until
        ...
        FirebaseFirestore.getInstance().collection("Nanded")
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot snapshot) {
                        ...
                        String size = snapshot.getString("size");
                        ...
                        if (prize.isEmpty()){
                            holder.binding.prize.setText("Didn't given");

                        }else {
                            holder.binding.prize.setText(prize+"₹");

                        }  if (prize.isEmpty()){
                            holder.binding.size.setText("Didn't given");


                        }else {
                            holder.binding.size.setText(size);
                                                                        ...
                                                                        FirebaseFirestore.getInstance().collection("Nanded")
                                                                                ...
                                                                                .delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                                    ...
                                                                                    public void onSuccess(Void unused) {
                                                                                        ...
                                                                                        Toast.makeText(context, "Your property account deleted successfully", Toast.LENGTH_LONG).show();
                        ...
                        public void run() {
                            ...
                            mInterstitialAdedit.setFullScreenContentCallback(new FullScreenContentCallback() {
                                ...
                                public void onAdDismissedFullScreenContent() {
                                    ...
                                    mInterstitialAdedit=null;
                                    Intent intent=new Intent(context, EditSellDataActivity.class);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ShowsellownersampleBinding binding;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            binding = ShowsellownersampleBinding.bind(itemView);
        }
    }
}
