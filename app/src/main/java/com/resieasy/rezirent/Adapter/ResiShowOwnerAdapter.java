...
import com.resieasy.rezirent.Activity.MainActivity;
...
public class ResiShowOwnerAdapter extends RecyclerView.Adapter<ResiShowOwnerAdapter.ViewHolder> {
    ...
    public ResiShowOwnerAdapter(ArrayList<SingleIDClass> list,Context context) {
    ...
    @NonNull
    @Override
    public ResiShowOwnerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.showresidencysample, parent, false);
        return new ViewHolder(view);

    }

    @Override
    public void onBindViewHolder(@NonNull ResiShowOwnerAdapter.ViewHolder holder, int position) {
       ...
       String id = data.getId();
        ...
        InterstitialAd.load(context, String.valueOf(R.string.Ownresieditinterstitial_id), adRequestedit,
        ...
        InterstitialAd.load(context, String.valueOf(R.string.Ownresishowinterstitial_id), adRequestshow,
                new InterstitialAdLoadCallback() {
                    @Override
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        // The mInterstitialAd reference will be null until
                        ...
                        public void run() {
                            ...
                            mInterstitialAdedit.setFullScreenContentCallback(new FullScreenContentCallback() {
                                ...
                                public void onAdDismissedFullScreenContent() {
                                    ...
                                    mInterstitialAdedit=null;
                                    Intent intent = new Intent(context, EditResidencyDataActivity.class);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ShowresidencysampleBinding binding;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            binding = ShowresidencysampleBinding.bind(itemView);
        }
    }
}
